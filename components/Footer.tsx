...
export function Footer() {
  return (
    <footer id="contact" aria-labelledby="contact-h" className="border-t border-line bg-raised">
      <div className="mx-auto flex max-w-[1120px] flex-wrap justify-between gap-[clamp(32px,4vw,64px)] px-6 pt-[clamp(56px,7vw,104px)] pb-[clamp(36px,4vw,56px)]">
        <h2
          id="contact-h"
      ...
      <div className="mx-auto flex max-w-[1120px] flex-wrap justify-between gap-x-6 gap-y-2.5 px-6 pb-[clamp(40px,5vw,64px)] font-mono text-xs text-meta">
        <p className="m-0">{site.footer.legal}</p>
        <p className="m-0">{site.footer.copyright}</p>
      </div>
    </footer>
  );
}
